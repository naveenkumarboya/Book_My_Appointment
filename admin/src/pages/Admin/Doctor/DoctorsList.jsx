...
const DoctorsList = () => {
  ...
  return (
    <div className='m-5 mah-h-[-90vh] overflow-y-scroll hide-scrollbar'> 
      ...
      <div className='w-full flex flex-wrap gap-4 pt-5 gap-y-6'>
        {
          doctors.map((item,index)=>(
            <div className='border border-indigo-200 rounded-xl max-w-56 overflow-hidden group cursor-pointer' key={index}>
              <img className='bg-indigo-50 group-hover:bg-[#5F6FFF] transition-all duration-350' src={item.image} alt="" />
              <div className='p-4'>
